...
export default function LandingCotizadora() {
  ...
  return (
    <div className="min-h-screen bg-[url('/hero-car.png')] bg-cover bg-center bg-no-repeat relative overflow-hidden">
      {/* Navbar */}
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            {/* Glow Effect */}
            <div className="absolute inset-0 bg-linear-to-br from-pink-400 to-purple-400 rounded-3xl blur-2xl opacity-50"></div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-purple-200 focus:border-purple-500 transition-all text-2xl text-center text-black font-bold tracking-widest"
                    placeholder="1234"
                  />
                  {error && (
                ...
                <button
                  ...
                  className="w-full bg-linear-to-r from-indigo-600 to-purple-600 text-white py-5 rounded-2xl font-bold text-lg hover:from-indigo-700 hover:to-purple-700 transform hover:scale-105 transition-all shadow-lg hover:shadow-xl cursor-pointer"
                >
                  Cotizar Ahora
                </button>
